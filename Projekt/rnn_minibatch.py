...
class RNN(object):
    ...
    def __init__(self, input, n_in, n_hidden, n_out, activation=T.tanh,
        ...
        if self.output_type == 'real':
            ...
            y_p = self.y_pred
            y_p_m = T.reshape(y_p, (y_p.shape[0] * y_p.shape[1], y_p.size / (y_p.shape[0] * y_p.shape[1])))
    ...
    def nll_multiclass(self, y):
        ...
        p_y_m = T.reshape(p_y, (p_y.shape[0] * p_y.shape[1], p_y.size / (p_y.shape[0] * p_y.shape[1])))
                ...
                if (self.epoch) % validate_every == 0:
                    ...
                    if self.interactive:
                        ...
                        if compute_zero_one:
                            ...
                            logger.info('epoch %i, tr loss %f, te loss %f, lr %f' % \
                                        (self.epoch, this_train_loss,
